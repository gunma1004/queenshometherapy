...
# 1. 서울, 경기, 인천 전체 구 및 동 데이터 정의
full_regions_data = {
    "seoul": {
        "name": "서울",
        "districts": {
            "jongno": {"name": "종로구", "dongs": ["청운동", "신교동", "궁정동", "효자동", "창성동", "통인동", "체부동", "통의동", "사직동", "적선동", "도렴동", "내자동", "필운동", "누상동", "누하동", "옥인동", "통인동", "회현동", "명동", "종로1가", "종로2가", "종로3가", "종로4가", "종로5가", "종로6가", "인의동", "원남동", "연지동", "효제동", "동숭동", "이화동", "혜화동", "명륜1가", "명륜2가", "명륜3가", "명륜4가", "창신동", "숭인동", "교남동", "평동", "송월동", "홍파동", "신문로1가", "신문로2가", "무악동", "교북동", "행촌동", "삼청동", "안국동", "팔판동", "소격동", "화동", "사간동", "송현동", "가회동", "재동", "계동", "원서동", "익선동", "경운동", "관훈동", "낙원동", "인사동", "묘동", "종로1·2·3·4가동", "종로5·6가동"]},
            "jung-seoul": {"name": "중구", "dongs": ["무교동", "다동", "태평로1가", "을지로1가", "을지로2가", "남대문로1가", "남대문로2가", "삼각동", "수하동", "장교동", "수표동", "을지로3가", "주교동", "방산동", "오장동", "입정동", "산림동", "을지로4가", "을지로5가", "을지로6가", "장충동1가", "장충동2가", "광희동1가", "광희동2가", "을지로7가", "쌍림동", "방배동", "소공동", "회현동1가", "회현동2가", "남산동1가", "남산동23가", "후암동", "남창동", "양동", "필동1가", "필동2가", "필동3가", "남학동", "주자동", "예관동", "묵정동", "신당동", "흥인동", "선린동", "다산동", "약수동", "청구동", "신당제5동", "동화동", "황학동", "중림동", "신교동"]},
            "yongsan": {"name": "용산구", "dongs": ["후암동", "용산동2가", "용산동3가", "용산동4가", "용산동5가", "용산동6가", "동자동", "갈월동", "남영동", "한강로1가", "한강로2가", "한강로3가", "원효로1가", "원효로2가", "원효로3가", "원효로4가", "신창동", "산천동", "청암동", "효창동", "도원동", "용문동", "문배동", "신계동", "이촌동", "이태원동", "한남동", "동빙고동", "서빙고동", "주성동", "보광동", "청파동1가", "청파동2가", "청파동3가", "원효로제1동", "원효로제2동", "한강로동", "이촌제1동", "이촌제2동", "서빙고동", "보광동"]},
            "seongdong": {"name": "성동구", "dongs": ["상왕십리동", "하왕십리동", "홍익동", "도선동", "마장동", "사근동", "행당동", "응봉동", "금호동1가", "금호동2가", "금호동3가", "금호동4가", "옥수동", "성수동1가", "성수동2가", "송정동", "용답동", "왕십리제2동", "왕십리도선동", "행당제1동", "행당제2동", "금호제1가동", "금호제23가동", "금호제4가동", "성수1가제1동", "성수1가제2동", "성수2가제1동", "성수2가제3동"]},
            "gwangjin": {"name": "광진구", "dongs": ["중곡동", "능동", "구의동", "광장동", "자양동", "화양동", "군자동", "중곡제1동", "중곡제2동", "중곡제3동", "중곡제4동", "구의제1동", "구의제2동", "구의제3동", "자양제1동", "자양제2동", "자양제3동", "자양제4동"]},
            "dongdaemun": {"name": "동대문구", "dongs": ["신설동", "용두동", "제기동", "전농동", "답십리동", "장안동", "청량리동", "회기동", "휘경동", "이문동", "용두제1동", "용두제2동", "전농제1동", "전농제2동", "답십리제1동", "답십리제2동", "장안제1동", "장안제2동", "회기동", "휘경제1동", "휘경제2동", "이문제1동", "이문제2동"]},
            "jungnang": {"name": "중랑구", "dongs": ["면목동", "상봉동", "중화동", "묵동", "망우동", "신내동", "면목본동", "면목제2동", "면목제34동", "면목제5동", "상봉제1동", "상봉제2동", "중화제1동", "중화제2동", "묵제1동", "묵제2동", "망우제3동", "망우본동", "신내제1동", "신내제2동"]},
            "seongbuk": {"name": "성북구", "dongs": ["성북동1가", "성북동", "동소문동1가", "동소문동2가", "동소문동3가", "동소문동4가", "동소문동5가", "동소문동6가", "동소문동7가", "삼선동1가", "삼선동2가", "삼선동3가", "삼선동4가", "동선동1가", "동선동2가", "동선동3가", "동선동4가", "동선동5가", "돈암동", "안암동1가", "안암동2가", "안암동3가", "안암동4가", "안암동5가", "보문동1가", "보문동2가", "보문동3가", "보문동4가", "보문동5가", "보문동6가", "정릉동", "길음동", "종암동", "하월곡동", "상월곡동", "장위동", "석관동", "삼선동", "동선동", "돈암제1동", "돈암제2동", "안암동", "보문동", "정릉제1동", "정릉제2동", "정릉제3동", "정릉제4동", "길음제1동", "길음제2동", "월곡제1동", "월곡제2동", "장위제1동", "장위제2동", "장위제3동"]},
            "gangbuk": {"name": "강북구", "dongs": ["미아동", "번동", "수유동", "우이동", "삼양동", "삼각산동", "송천동", "송중동", "인수동"]},
            "dobong": {"name": "도봉구", "dongs": ["창동", "도봉동", "방학동", "쌍문동", "쌍문제1동", "쌍문제2동", "쌍문제3동", "쌍문제4동", "방학제1동", "방학제2동", "방학제3동", "창제1동", "창제2동", "창제3동", "창제4동", "창제5동", "도봉제1동", "도봉제2동"]},
            "nowon": {"name": "노원구", "dongs": ["월계동", "공릉동", "하계동", "중계동", "상계동", "중계본동", "중계1동", "중계4동", "상계1동", "상계2동", "상계34동", "상계5동", "상계8동", "상계9동", "상계10동", "월계1동", "월계2동", "월계3동", "공릉1동", "공릉2동", "하계1동", "하계2동"]},
            "eunpyeong": {"name": "은평구", "dongs": ["불광동", "갈현동", "구산동", "대조동", "응암동", "역촌동", "신사동", "증산동", "수색동", "진관동", "녹번동", "불광제1동", "불광제2동", "갈현제1동", "갈현제2동", "응암제1동", "응암제2동", "응암제3동", "신사제1동", "신사제2동"]},
            "seodaemun": {"name": "서대문구", "dongs": ["충정로동", "천연동", "북아현동", "신촌동", "연희동", "홍제동", "홍은동", "남가좌동", "북가좌동", "홍제제1동", "홍제제2동", "홍제제3동", "홍은제1동", "홍은제2동", "남가좌제1동", "남가좌제2동", "북가좌제1동", "북가좌제2동"]},
            "mapo": {"name": "마포구", "dongs": ["아현동", "공덕동", "도화동", "용강동", "토정동", "신수동", "구수동", "창전동", "상수동", "하중동", "신정동", "당인동", "서교동", "동교동", "합정동", "망원동", "연남동", "성산동", "상암동", "염리동", "대흥동", "공덕동", "망원제1동", "망원제2동", "성산제1동", "성산제2동"]},
            "yangcheon": {"name": "양천구", "dongs": ["신정동", "목동", "신월동", "목제1동", "목제2동", "목제3동", "목제4동", "목제5동", "신월제1동", "신월제2동", "신월제3동", "신월제4동", "신월제5동", "신월제6동", "신월제7동", "신정제1동", "신정제2동", "신정제3동", "신정제4동", "신정제6동", "신정제7동"]},
            "gangseo": {"name": "강서구", "dongs": ["염창동", "등촌동", "화곡동", "가양동", "마곡동", "내발산동", "외발산동", "공항동", "방화동", "개화동", "과해동", "오곡동", "오쇠동", "발산동", "화곡본동", "화곡제1동", "화곡제2동", "화곡제3동", "화곡제4동", "화곡제6동", "화곡제8동", "우장산동"]},
            "guro": {"name": "구로구", "dongs": ["신도림동", "구로동", "가리봉동", "오류동", "개봉동", "고척동", "궁동", "항동", "천왕동", "수궁동", "구로제1동", "구로제2동", "구로제3동", "구로제4동", "구로제5동", "개봉제1동", "개봉제2동", "개봉제3동", "고척제1동", "고척제2동", "오류제1동", "오류제2동"]},
            "geumcheon": {"name": "금천구", "dongs": ["가산동", "독산동", "시흥동", "독산제1동", "독산제2동", "독산제3동", "독산제4동", "시흥제1동", "시흥제2동", "시흥제3동", "시흥제4동", "시흥제5동"]},
            "yeongdeungpo": {"name": "영등포구", "dongs": ["영등포동", "영등포동1가", "영등포동2가", "영등포동3가", "영등포동4가", "영등포동5가", "영등포동6가", "영등포동7가", "영등포동8가", "여의도동", "당산동", "당산동1가", "당산동2가", "당산동3가", "당산동4가", "당산동5가", "당산동6가", "도림동", "문래동1가", "문래동2가", "문래동3가", "문래동4가", "문래동5가", "문래동6가", "양평동", "양평동1가", "양평동2가", "양평동3가", "양평동4가", "양평동5가", "양평동6가", "신길동", "대림동"]},
            "dongjak": {"name": "동작구", "dongs": ["노량진동", "상도동", "상도제1동", "상도제2동", "상도제3동", "본동", "흑석동", "동작동", "사당동", "사당제1동", "사당제2동", "사당제3동", "사당제4동", "대방동", "신대방동", "신대방제1동", "신대방제2동"]},
            "gwanak": {"name": "관악구", "dongs": ["봉천동", "신림동", "남현동", "보라매동", "청림동", "성현동", "행운동", "낙성대동", "청룡동", "은천동", "난향동", "조원동", "대학동", "삼성동", "서원동", "신원동", "서림동", "난곡동", "신사동"]},
            "seocho": {"name": "서초구", "dongs": ["서초동", "잠원동", "반포동", "방배동", "양재동", "우면동", "원지동", "내곡동", "신원동", "반포본동", "반포제1동", "반포제2동", "반포제3동", "반포제4동", "방배본동", "방배제1동", "방배제2동", "방배제3동", "방배제4동", "양재제1동", "양재제2동"]},
            "gangnam": {"name": "강남구", "dongs": ["역삼동", "개포동", "청담동", "삼성동", "대치동", "신사동", "논현동", "압구정동", "세곡동", "자곡동", "율현동", "일원동", "수서동", "도곡동", "역삼제1동", "역삼제2동", "개포제1동", "개포제2동", "개포제4동", "청담동", "삼성제1동", "삼성제2동", "대치제1동", "대치제2동", "대치제4동", "논현제1동", "논현제2동", "일원제1동", "일원제2동", "일원본동", "도곡제1동", "도곡제2동"]},
            "songpa": {"name": "송파구", "dongs": ["잠실동", "신천동", "풍납동", "송파동", "석촌동", "삼전동", "가락동", "문정동", "장지동", "방이동", "오금동", "거여동", "마천동", "풍납제1동", "풍납제2동", "방이제1동", "방이제2동", "오금동", "송파제1동", "송파제2동", "석촌동", "삼전동", "가락본동", "가락제1동", "가락제2동", "문정제1동", "문정제2동", "장지동", "위례동", "잠실본동", "잠실제2동", "잠실제3동", "잠실제4동", "잠실제6동", "잠실제7동"]},
            "gangdong": {"name": "강동구", "dongs": ["강일동", "상일동", "명일동", "고덕동", "암사동", "천호동", "성내동", "둔촌동", "암사제1동", "암사제2동", "암사제3동", "천호제1동", "천호제2동", "천호제3동", "성내제1동", "성내제2동", "성내제3동", "둔촌제1동", "둔촌제2동", "길동"]}
        }
    },
    "gyeonggi": {
        "name": "경기",
        "districts": {
            "suwon": {"name": "수원시", "dongs": ["파장동", "정자동", "이목동", "율전동", "천천동", "조원동", "영화동", "송죽동", "연무동", "상광교동", "하광교동", "세류동", "평동", "서둔동", "구운동", "탑동", "금곡동", "호매실동", "오목천동", "고색동", "권선동", "곡반정동", "대황교동", "입북동", "당수동", "팔달로", "중앙동", "교동", "남창동", "신풍동", "장안동", "매향동", "북수동", "서둔동", "지동", "우만동", "인계동", "매교동", "매산동", "고등동", "원천동", "매탄동", "영통동", "이의동", "하동", "망포동", "태장동"]},
            "seongnam": {"name": "성남시", "dongs": ["신흥동", "태평동", "수진동", "단대동", "산성동", "양지동", "복정동", "창곡동", "상적동", "둔전동", "시흥동", "금토동", "심곡동", "신촌동", "오야동", "여수동", "도촌동", "갈현동", "하대원동", "중앙동", "성남동", "상대원동", "분당동", "수내동", "정자동", "서현동", "이매동", "야탑동", "금곡동", "기산동", "구미동", "판교동", "삼평동", "백현동", "운중동", "대장동", "석운동", "하산운동"]},
            "uijeongbu": {"name": "의정부시", "dongs": ["의정부동", "호원동", "장암동", "신곡동", "용현동", "민락동", "낙양동", "자일동", "금오동", "가능동", "녹양동", "고산동"]},
            "anyang": {"name": "안양시", "dongs": ["안양동", "석수동", "박달동", "비산동", "관양동", "평촌동", "호계동", "부흥동", "달안동", "부림동", "귀인동", "범계동", "신촌동", "갈산동"]},
            "bucheon": {"name": "부천시", "dongs": ["원미동", "역곡동", "심곡동", "춘의동", "도당동", "상동", "중동", "소사동", "범박동", "옥길동", "괴안동", "송내동", "소사본동", "오정동", "여월동", "작동", "원종동", "고강동", "삼정동", "내동"]},
            "gwangmyeong": {"name": "광명시", "dongs": ["광명동", "철산동", "하안동", "소하동", "노온사동", "가학동", "일직동"]},
            "pyeongtaek": {"name": "평택시", "dongs": ["팽성읍", "안중읍", "포승읍", "청북읍", "진위면", "서탄면", "고덕면", "오성면", "현덕면", "신평동", "원평동", "통복동", "세교동", "송탄동", "지산동", "송북동", "신장동", "서정동", "중앙동", "비전동", "동삭동", "용이동", "고덕동"]},
            "dongducheon": {"name": "동두천시", "dongs": ["생연동", "보산동", "동두천동", "안흥동", "상패동", "송내동", "지행동", "광암동", "탑동동", "상봉암동", "하봉암동", "보산동", "불현동", "소요동"]},
            "ansan": {"name": "안산시", "dongs": ["사동", "일동", "이동", "본오동", "반월동", "팔곡동", "양상동", "성포동", "월피동", "부곡동", "선부동", "원곡동", "백운동", "초지동", "고잔동", "대부동", "화정동", "신길동", "원시동", "목내동", "성곡동"]},
            "goyang": {"name": "고양시", "dongs": ["원흥동", "성사동", "주교동", "대자동", "관산동", "효자동", "지축동", "오금동", "삼송동", "신원동", "원당동", "화정동", "행신동", "토당동", "강매동", "내곡동", "대장동", "신평동", "주교동", "일산동", "탄현동", "중산동", "정발산동", "마두동", "백석동", "식사동", "풍동", "산황동", "문봉동", "설문동", "지영동", "일산동", "가좌동", "대화동", "주엽동", "킨텍스", "덕이동", "법곳동"]},
            "gwacheon": {"name": "과천시", "dongs": ["과천동", "문원동", "별양동", "중앙동", "갈현동", "막계동", "주암동"]},
            "guri": {"name": "구리시", "dongs": ["갈매동", "동구동", "인창동", "교문동", "수택동", "아천동", "토평동"]},
            "namyangju": {"name": "남양주시", "dongs": ["와부읍", "진접읍", "화도읍", "수동면", "조안면", "진건읍", "퇴계원읍", "오남읍", "별내면", "별내동", "다산동", "금곡동", "평내동", "호평동", "지금동", "배양동"]},
            "osan": {"name": "오산시", "dongs": ["궐동", "누읍동", "가탑동", "서동", "벌음동", "두곡동", "부산동", "원동", "청호동", "고현동", "청학동", "은계동", "양산동", "가수동", "가장동", "내삼미동", "외삼미동", "수청동", "오산동", "세교동"]},
            "siheung": {"name": "시흥시", "dongs": ["대야동", "신천동", "은행동", "안현동", "매화동", "도창동", "과림동", "무지내동", "목감동", "산현동", "조남동", "거모동", "군자동", "월곶동", "장곡동", "장현동", "하중동", "하상동", "광석동", "능곡동", "화정동", "배곧동", "정왕동", "오이도"]},
            "gunpo": {"name": "군포시", "dongs": ["산본동", "금정동", "당동", "부곡동", "대야미동", "둔대동", "속달동", "광정동", "수리동", "궁내동", "오금동", "재궁동", "오행동"]},
            "uiwang": {"name": "의왕시", "dongs": ["고천동", "부곡동", "오전동", "내손동", "청계동", "초평동", "월암동", "삼동", "포일동"]},
            "hanam": {"name": "하남시", "dongs": ["천현동", "신장동", "풍산동", "창우동", "배알미동", "상산곡동", "하산곡동", "교산동", "춘궁동", "하사창동", "상사창동", "선동", "덕풍동", "감일동", "감이동", "학암동", "망월동", "미사동", "위례동"]},
            "yongin": {"name": "용인시", "dongs": ["포곡읍", "모현읍", "남사읍", "원삼면", "백암면", "양지면", "유림동", "중앙동", "동부동", "역북동", "삼가동", "유방동", "고림동", "마평동", "운학동", "호동", "해곡동", "풍덕천동", "신봉동", "죽전동", "동천동", "상현동", "성복동", "구갈동", "상갈동", "보라동", "농서동", "서천동", "지곡동", "공세동", "보정동", "마북동", "청덕동", "하갈동", "영덕동", "동백동", "중동", "언남동", "마북동"]},
            "paju": {"name": "파주시", "dongs": ["문산읍", "조리읍", "법원읍", "파주읍", "월롱면", "탄현면", "광탄면", "적성면", "파평면", "교하동", "금촌동", "운정동", "동패동", "목동동", "야당동", "와동동"]},
            "icheon": {"name": "이천시", "dongs": ["장호원읍", "마장면", "부발읍", "신둔면", "백사면", "호법면", "대월면", "모가면", "설성면", "율면", "창전동", "중리동", "증포동", "관고동", "진리동", "송정동"]},
            "anseong": {"name": "안성시", "dongs": ["공도읍", "보개면", "금광면", "서운면", "미양면", "대덕면", "원곡면", "양성면", "고삼면", "일죽면", "죽산면", "삼죽면", "성남동", "동본동", "명륜동", "신건지동", "당왕동", "금석동", "아양동", "옥산동", "사곡동", "도기동"]},
            "gimpo": {"name": "김포시", "dongs": ["통진읍", "고촌읍", "양촌읍", "대곶면", "월곶면", "하성면", "사우동", "풍무동", "걸포동", "운양동", "장기동", "장기본동", "구래동", "마산동", "통진읍"]},
            "hwaseong": {"name": "화성시", "dongs": ["봉담읍", "우정읍", "향남읍", "남양읍", "매송면", "비봉면", "마도면", "송산면", "서신면", "팔탄면", "장안면", "양감면", "정남면", "병점동", "반송동", "동탄동", "능동", "기산동", "반월동", "석우동", "오산동", "영천동", "중동", "신동", "방교동", "금곡동", "송동", "산척동", "목동", "장지동", "반정동", "진안동", "기배동", "화산동"]},
            "gwangju-gy": {"name": "광주시", "dongs": ["오포읍", "초월읍", "곤지암읍", "도척면", "퇴촌면", "남종면", "남한산성면", "경안동", "송정동", "광남동", "쌍령동", "회덕동", "탄벌동", "역동", "목현동", "삼동", "중대동", "직동", "장지동", "태전동", "양벌동", "매산동", "추자동", "신현동", "능평동"]},
            "yangju": {"name": "양주시", "dongs": ["회천동", "백석읍", "은현면", "남면", "장흥면", "광적면", "양주동", "고읍동", "만송동", "삼숭동", "옥정동", "율정동", "회암동", "산북동", "덕계동", "덕정동", "봉양동"]},
            "pocheon": {"name": "포천시", "dongs": ["소흘읍", "군내면", "내촌면", "가산면", "일동면", "이동면", "직동면", "화현면", "창수면", "영중면", "영북면", "관인면", "신북면", "포천동", "선단동"]},
            "yeoju": {"name": "여주시", "dongs": ["가남읍", "점동면", "능서면", "흥천면", "금사면", "산북면", "대신면", "북내면", "강천면", "여흥동", "중앙동", "오학동"]},
            "yeoncheon": {"name": "연천군", "dongs": ["연천읍", "전곡읍", "군남면", "청산면", "백학면", "미산면", "왕징면", "신서면", "중면", "장남면"]},
            "gapyeong": {"name": "가평군", "dongs": ["가평읍", "설악면", "상면", "하면", "북면", "조종면", "청평면"]},
    ...
    "incheon": {
        "name": "인천",
        "districts": {
            "jemulpo": {"name": "제물포구", "dongs": ["중앙동", "해안동", "항동", "관동", "송학동", "사동", "신생동", "신흥동", "답동", "신포동", "도원동", "유동", "율목동", "선화동", "도화동", "주안동", "용현동", "학익동", "숭의동", "만석동", "화수동", "화평동", "송현동", "창영동", "금곡동", "송림동"]},
            ...
            "namdong": {"name": "남동구", "dongs": ["구월동", "간석동", "만수동", "장수동", "서창동", "운연동", "수산동", "도림동", "고잔동", "논현동", "배곧동"]},
            "bupyeong": {"name": "부평구", "dongs": ["부평동", "일신동", "십정동", "산곡동", "청천동", "삼산동", "갈산동", "부개동"]},
            "gyeyang": {"name": "계양구", "dongs": ["효성동", "작전동", "서운동", "임학동", "용종동", "병방동", "방축동", "동양동", "귤현동", "상야동", "하야동", "평동", "노오지동", "선주지동", "이화동", "둑실동", "목상동", "다남동", "장기동", "계산동"]},
            "seohae": {"name": "서해구", "dongs": ["연평면", "백령면", "대청면", "덕적면", "자월면", "영흥면"]},
            "geomdan": {"name": "검단구", "dongs": ["검암동", "경서동", "원당동", "당하동", "마전동", "불로동", "대곡동", "금곡동", "오류동", "왕길동", "불로대곡동", "아라동", "당하동", "원당동", "마전동", "오류왕길동", "검단동"]},
...
<main role="main">
  <section style="background:#15151f;padding:140px 20px 90px;text-align:center;">
    <div class="container">
...
print(f"총 {count}개의 서울·경기·인천 구/시 및 동별 출장마사지 페이지 생성이 완료되었습니다!")
